...
**現在の release は 0.3.6 です。** Architecture は [ZDS 0002](docs/zds/records/0002-zenfmt-architecture.typ)、IR v2、facets、writer lowering は [ZDS 0013](docs/zds/records/0013-layered-document-ir.typ) に記録されています。ZDS は設計記録なので英語のままです。
