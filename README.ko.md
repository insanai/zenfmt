...
**현재 release는 0.3.2입니다.** Architecture는 [ZDS 0002](docs/zds/records/0002-zenfmt-architecture.typ), IR v2와 facets, writer lowering은 [ZDS 0013](docs/zds/records/0013-layered-document-ir.typ)에 기록되어 있습니다. ZDS는 설계 기록이므로 영어로 유지합니다.
